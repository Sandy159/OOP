...
private:
    ...
    int get_last_set_int_index() const;
    int get_last_set_trit_index() const;
    ...
    public:
        ...
        Proxy_trit(int index, const vector<unsigned int>& arr, const Tritset& tritset);
    ...
    class Iterator {
    private:
        const Tritset& tritset_;
        int index_;
    public:
        Iterator(const int index, const Tritset& tritset);
        Iterator operator++();
